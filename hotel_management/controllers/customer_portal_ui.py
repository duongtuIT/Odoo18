...
class CustomerPortal(http.Controller):
    ...
    def available_rooms(self, **kwargs):
        ...
        return request.render('hotel_management.available_rooms_template', {
    ...
    def book_room(self, room_id, **kwargs):
        ...
        return request.render('hotel_management.book_room_template', values)
    ...
    def confirm_booking(self, **kwargs):
        ...
        try:
            request.env['booking.order'].sudo().create(booking_data)
        except Exception as e:
            return request.render('hotel_management.booking_error_template', {'error': str(e)})

        return request.render('hotel_management.booking_success_template', {'booking_code': booking_data['booking_code']})
